  ...
  const values = [
    {
      ...
      description: "We push the boundaries of what's possible with AI technology, constantly innovating to deliver cutting- edge solutions.",
      id: 'innovation'
    },
    {
      icon: Users,
      title: 'Customer Success',
      description: "Your success is our success. We're committed to providing exceptional support and ensuring your goals are met.",
      id: 'customer'
    },
    {
      icon: Award,
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <section aria-labelledby="mission-heading">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600 max-w-2xl mx-auto text-center">
              We&apos;re on a mission to revolutionize visual AI technology and make it accessible to businesses of all sizes. Our innovative solutions help companies unlock the full potential of their visual data.
            </p>
          </section>
            ...
            <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
              {stats.map((stat) => (
                <div key={stat.id} className="text-center">
                  <div className="text-4xl font-bold text-indigo-600" aria-label={`${stat.value} ${stat.label}`}>
                    {stat.value}
                  </div>
          ...
          <section aria-labelledby="values-heading" className="mt-24">
            <h2 id="values-heading" className="text-3xl font-bold text-gray-900 text-center mb-12">
              Our Values
            </h2>
            <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
              {values.map((value) => (
                <Card key={value.id} className="hover:shadow-xl transition-shadow">
                  <CardContent className="p-8">
                    <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-indigo-50 mb-6">
                      <value.icon className="h-6 w-6 text-indigo-600" aria-hidden="true" />
                    </div>
          ...
          <section aria-labelledby="team-heading" className="mt-24">
            <h2 id="team-heading" className="text-3xl font-bold text-gray-900 text-center mb-12">
              Our Leadership Team
            </h2>
