...
// 						</button>
// 						<Link to="/docs" className="text-sm font-semibold leading-6 text-gray-900 flex items-center group">
// 							Documentation
...
const Hero = () => (
  <div className="relative pt-40 md:pt-40 pb-20 overflow-hidden">
    ...
    <div className="relative">
      <div
        className="absolute -top-4 -z-10 transform-gpu overflow-hidden blur-3xl"
        aria-hidden="true"
      >
        <div className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-indigo-500 to-[#9089fc] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]" />
      </div>
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Unlock the power of AI to understand images and engage in natural
            conversations. Upload any image and get started.
          </p>
          <div className="mt-10 flex items-center justify-center gap-x-6">
            {/* Updated to use Link */}
            <Link
