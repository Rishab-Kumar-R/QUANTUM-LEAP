...
import { Menu, X, Command, Github, ChevronDown, Info, Mail, HelpCircle, Cog } from 'lucide-react';
import {
  DropdownMenuContent,
  DropdownMenuItem,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <Link to="/" className="flex items-center hover:opacity-90 transition-opacity">
            ...
            <span className="ml-2 text-xl font-bold text-indigo-600">QUANTUM-LEAP</span>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="relative dropdown-container">
                ...
                <DropdownMenuContent
                  className={`absolute right-0 mt-2 w-64 bg-white shadow-lg p-2 rounded-md z-10 transition-all duration-300 transform ${isDropdownOpen ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-2 pointer-events-none'
                    }`}
                >
