  ...
  return (
    <div className="flex min-h-screen bg-gray-50 items-center justify-center">
      <div className="w-full max-w-7xl flex flex-col md:flex-row bg-white rounded-lg shadow-xl overflow-hidden min-h-[600px]">
        ...
        {/* Right Section for Logo/Text */}
        <div className="w-full md:w-1/2 flex items-center justify-center p-8 bg-gray-100">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-indigo-600">Quantum Leap</h1>
            <p className="mt-2 text-gray-600">
              Start your journey with us and explore new possibilities with AI-powered image recognition.
            </p>
          </div>
        </div>
